...
public class ListNode extends ExpressionNode {
    ...
    @Override
    public io.vavr.collection.List<Either<CompileError, Op>> apply(BuildData data, LinkedHashMap<String, Value> valueMap) throws ParseException {
        return List.of(Op.invokeStaticInterface(Classes.LIST, "empty", "()L" + Classes.LIST + ";"))
                .appendAll(elements.flatMap(element ->
                        element._1.apply(data, valueMap)
