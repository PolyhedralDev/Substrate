...
import com.dfsek.substrate.lang.impl.operations.variable.assignment.NumberVariableAssignmentOperation;
...
public class NumberVariableAssignmentRule extends VariableAssignmentRule {
    ...
    public Operation assemble(Tokenizer tokenizer, Parser parser) throws ParseException {
        ...
        return new NumberVariableAssignmentOperation(new ExpressionRule().assemble(tokenizer, parser), id.getContent(), assignment.getPosition());
    }
}
