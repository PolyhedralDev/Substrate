...
public class LessThanOperationNumber extends NumberComparisonOperation {
    public LessThanOperationNumber(Operation left, Operation right, Position position) {
    ...
    public void applyOperation(MethodVisitor visitor, BuildData data) throws ParseException {
        ...
        visitor.visitJumpInsn(IFGE, notEqual);
