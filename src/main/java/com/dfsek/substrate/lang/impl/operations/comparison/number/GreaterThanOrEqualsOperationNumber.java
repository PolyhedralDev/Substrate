...
public class GreaterThanOrEqualsOperationNumber extends NumberComparisonOperation {
    public GreaterThanOrEqualsOperationNumber(Operation left, Operation right, Position position) {
    ...
    public void applyOperation(MethodVisitor visitor, BuildData data) throws ParseException {
        ...
        visitor.visitJumpInsn(IFLT, notEqual);
