...
public class LessThanOrEqualsOperationNumber extends NumberComparisonOperation {
    public LessThanOrEqualsOperationNumber(Operation left, Operation right, Position position) {
    ...
    public void applyOperation(MethodVisitor visitor, BuildData data) throws ParseException {
        ...
        visitor.visitJumpInsn(IFGT, notEqual);
