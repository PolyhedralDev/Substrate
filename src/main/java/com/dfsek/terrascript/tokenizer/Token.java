...
public class Token {
    ...
    private final com.dfsek.terrascript.tokenizer.Position start;

    public Token(String content, Type type, com.dfsek.terrascript.tokenizer.Position start) {
    ...
    public com.dfsek.terrascript.tokenizer.Position getPosition() {
        return start;
    }
