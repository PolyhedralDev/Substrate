...
public class Utils {
    ...
    public static <P extends Record, R extends Record> Parser<P, R> createParser(Class<P> params, Class<R> ret, boolean cheatingPrintln) throws NoSuchMethodException {
        Parser<P, R> parser = new Parser<>(params, ret);
